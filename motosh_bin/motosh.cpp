...
#define STM_FIRMWARE_BLACKLIST "/system/vendor/etc/firmware/sensorhub-blacklist.txt"
...
int stm_getFwFile(char *fileName, FirmwareType type) {
    ...
    switch (type) {
        case FW_APK:
            ...
            break;
        case FW_STOCK:
            ret = snprintf(fileName, STM_MAX_PATH, "/system/vendor/etc/firmware/sensorhubfw.bin");
            break;
        default:
